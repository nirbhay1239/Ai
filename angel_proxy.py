...
def login():
    ...
    try:
        ...
        r=requests.post("https://apiconnect.angelone.in/rest/auth/angelbroking/user/v1/loginByPassword",
            headers={"Content-Type":"application/json","X-APIKey":b["api_key"],"X-ClientID":b["client_id"],"X-SourceID":"WEB","X-UserType":"USER","X-ClientLocalIP":"192.168.1.1","X-ClientPublicIP":"106.0.0.1","X-MACAddress":"fe80::216e:6507:4b90:3719"},
...
def order():
    ...
    try:
        r=requests.post("https://apiconnect.angelone.in/rest/secure/angelbroking/order/v1/placeOrder",
            headers={"Authorization":f"Bearer {s['jwt']}","Content-Type":"application/json","X-APIKey":s["key"],"X-ClientID":s["cid"],"X-SourceID":"WEB","X-UserType":"USER","X-ClientLocalIP":"192.168.1.1","X-ClientPublicIP":"106.0.0.1","X-MACAddress":"fe80::216e:6507:4b90:3719"},
